...
llm=ChatOpenAI(api_key=my_secret,temperature=0.6)

#########################################################################################################################

random_city_Chooser="""You are a random city selector in India who job is to give out 1 name that starts with
{letter}\
"""
